        ...
        <View style={styles.cardTop}>
          <View style={[styles.typeChip, { backgroundColor: pc.bg }]}>
            <Text style={[styles.typeChipText, { color: pc.color }]}>
              {item.type === 'class' ? '🏫 Class' : '👤 Personal'} · {item.priority}
            </Text>
          </View>
        ...
        <View style={[styles.modalHeader, { borderBottomColor: pc.color }]}>
          <View style={{ flex: 1 }}>
            <View style={[styles.typeChip, { backgroundColor: pc.bg, marginBottom: 8 }]}>
              <Text style={[styles.typeChipText, { color: pc.color }]}>
                {item.type === 'class' ? '🏫 Class Announcement' : '👤 Personal Message'} · {item.priority}
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  unreadBadgeText: { color: Colors.white, fontSize: 13, fontWeight: '800' },
  ...
  typeChipText: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.3 },
  ...
  cardMessage: { fontSize: 13, color: Colors.textSecondary, lineHeight: 18, fontWeight: '500' },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 },
  cardTeacher: { fontSize: 11, color: Colors.textMuted, fontWeight: '600' },
  ...
  attachmentBadgeText: { fontSize: 11, color: Colors.primary, fontWeight: '700' },
  ...
  modalTitle: { fontSize: 20, fontWeight: '900', color: Colors.text, lineHeight: 26, marginBottom: 4 },
  modalMeta: { fontSize: 12, color: Colors.textMuted, fontWeight: '500' },
  closeBtn: {
    width: 36,
    height: 36,
    borderRadius: 10,
  ...
  attachmentLabel: { fontSize: 15, fontWeight: '700', color: Colors.text },
  attachmentSub: { fontSize: 12, color: Colors.textMuted, marginTop: 2 },
  readBadge: {
    marginTop: 24,
    flexDirection: 'row',
    alignItems: 'center',
