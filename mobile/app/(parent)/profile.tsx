...
const styles = StyleSheet.create({
  ...
  displayName: { fontSize: 24, fontWeight: '900', color: Colors.accent, letterSpacing: -0.5 },
  roleChip: {
    backgroundColor: Colors.surface,
  ...
  institutionTag: { fontSize: 12, color: Colors.textSecondary, fontWeight: '500' },

  infoCard: { gap: 0, borderWidth: 2, borderColor: Colors.primary, borderRadius: 20, backgroundColor: Colors.surface, ...neonShadows.blue },
  sectionTitle: {
    fontSize: 13,
    fontWeight: '800',
    color: Colors.accent,
  ...
  infoValue: { fontSize: 14, color: Colors.accent, fontWeight: '700', maxWidth: '60%', textAlign: 'right' },

  menuCard: { gap: 0, borderWidth: 2, borderColor: Colors.primary, borderRadius: 20, backgroundColor: Colors.surface, ...neonShadows.blue },
  menuItem: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 14,
  ...
  menuSub: { fontSize: 12, color: Colors.textSecondary, marginTop: 2, fontWeight: '500' },
