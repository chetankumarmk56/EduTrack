...
export default function Academics() {
   ...
   useEffect(() => {
      if (activeStudent?.id) {
         import('@/features/marks/api').then(({ marksApi }) => {
            marksApi.getRankings(activeStudent.id).then(setRankings).catch(console.error);
         });
      }
   }, [activeStudent?.id, marks]);
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
               ...
               <div className="flex gap-4">
                  ...
                  >
                     ...
                     <div>
                        <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Section Rank</p>
                        <p className="text-2xl font-black text-foreground">{rankings?.class_rank || '--'}<span className="text-xs text-muted-foreground ml-1">/ {rankings?.class_total || '--'}</span></p>
                     </div>
                  </motion.button>
                  ...
                  >
                     ...
                     <div>
                        <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Grade Rank</p>
                        <p className="text-2xl font-black text-foreground">{rankings?.grade_rank || '--'}<span className="text-xs text-muted-foreground ml-1">/ {rankings?.grade_total || '--'}</span></p>
                     </div>
                  </motion.button>
               </div>
            </div>
                           ...
                           >
                              <div className="flex justify-between items-start mb-10">
                                 ...
                                 <div className="text-right">
                                    ...
                                    <span className="text-[11px] font-black uppercase text-muted-foreground tracking-[0.2em] opacity-60">Percentage</span>
                                 </div>
                              </div>
                              ...
                              <div className="mb-10">
                                 ...
                                 <p className="text-sm text-muted-foreground font-medium flex items-center gap-3">
                                    ...
                                    Teacher: <span className="text-foreground font-black">{subj.teacher}</span>
                                 </p>
                              </div>
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                 <div className="p-5 rounded-3xl bg-muted/30 border border-glass-border shadow-inner">
                                    ...
                                    <p className="text-lg font-black text-foreground">{subj.count} Tests</p>
                                 </div>
                                 <div className="p-5 rounded-3xl bg-muted/30 border border-glass-border shadow-inner">
                  ...
                  >
                     <div className="px-5 sm:px-8 md:px-10 py-5 sm:py-8 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                           ...
                           <div>
                              <h2 className="text-2xl font-black text-foreground tracking-tight">{leaderboardTitle}</h2>
                              <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Cohort Performance Ranking</p>
                           </div>
                        </div>
                        <button
                           onClick={() => setSelectedLeaderboard(null)}
                           className="h-10 w-10 rounded-xl bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-500 transition-colors"
                        >
                           <X className="w-5 h-5" />
                        </button>
                     </div>
                              ...
                              >
                                 <div className="flex items-center gap-6">
                                    <div className={cn(
                                       ...
                                       isMe ? "bg-white/20 text-white" : "bg-slate-50 text-slate-400"
                                    )}>
                                       {entry.rank}
                                    </div>
                                    <div>
                                       ...
                                       <p className={cn("text-[10px] font-black uppercase tracking-widest", isMe ? "text-indigo-100" : "text-muted-foreground")}>
                                          Global Mastery: {entry.percentage}%
                                       </p>
                                    </div>
                                 </div>
                                 
                                 <div className="flex items-center gap-3">
                                    <div className={cn("h-1.5 w-24 rounded-full overflow-hidden", isMe ? "bg-white/10" : "bg-slate-100")}>
                                       <motion.div 
                                          initial={{ width: 0 }}
